...
g++ ejercicio8.cpp -o e8  # Cambia 'e2.cpp' al nombre de tu archivo de código fuente
...
input_folder="tests/ejercicio8"
output_folder="outputs"  # Puedes cambiarlo a donde quieras guardar las salidas
expected_folder="tests/ejercicio8"  # Carpeta para las salidas esperadas
...
declare -a test_cases=("10" "100" "1000" "10000" "100000" "1000000")  # Agrega más números según sea necesario
