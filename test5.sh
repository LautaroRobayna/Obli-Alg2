...
g++ ejercicio5.cpp -o e5  # Cambia 'e2.cpp' al nombre de tu archivo de código fuente
...
input_folder="tests/ejercicio5"
output_folder="outputs"  # Puedes cambiarlo a donde quieras guardar las salidas
expected_folder="tests/ejercicio5"  # Carpeta para las salidas esperadas
...
declare -a test_cases=("5" "10" "20" "30" "40" "50" "100" "200")  # Agrega más números según sea necesario
