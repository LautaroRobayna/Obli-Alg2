...
g++ ejercicio1.cpp -o e1  # Cambia 'e2.cpp' al nombre de tu archivo de código fuente
...
expected_folder="tests/ejercicio1"  # Carpeta para las salidas esperadas
...
declare -a test_cases=("11" "100" "1000" "10000" "100000")  # Agrega más números según sea necesario
