...
g++ ejercicio9.cpp -o e9  # Cambia 'e2.cpp' al nombre de tu archivo de código fuente
...
input_folder="tests/ejercicio9"
output_folder="outputs"  # Puedes cambiarlo a donde quieras guardar las salidas
expected_folder="tests/ejercicio9"  # Carpeta para las salidas esperadas
...
declare -a test_cases=("15" "25" "50" "75" "100"  "1000")  # Agrega más números según sea necesario
