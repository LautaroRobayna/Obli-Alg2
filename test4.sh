...
g++ ejercicio4.cpp -o e4  # Cambia 'e2.cpp' al nombre de tu archivo de código fuente
...
input_folder="tests/ejercicio4"
output_folder="outputs"  # Puedes cambiarlo a donde quieras guardar las salidas
expected_folder="tests/ejercicio4"  # Carpeta para las salidas esperadas
...
declare -a test_cases=("5" "10" "20" "100" "1000" "10000" "100000")  # Agrega más números según sea necesario
